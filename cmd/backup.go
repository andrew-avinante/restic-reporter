...
// runBackups loads the config and runs every job, publishing metrics to MQTT
// best-effort. It returns an error only if a backup job itself failed.
func runBackups(ctx context.Context, configPath string) error {
